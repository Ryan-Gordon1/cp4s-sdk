...
class SoarSubParser(ISubParser):
    ...
    def register_subparser(self, *args, **kwargs):
        ...
        soar_parser = parent.add_parser(self.product, help="Commands for developing Cases Apps and Integrations",
        ...
        soar_sub_parser = get_main_app_sub_parser(soar_parser)
